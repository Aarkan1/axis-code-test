...
const credentials: Credential[] = [
  {
    ...
    username: "alice",
    passwordHash:
      "17a96502d336e4c18a43182a353d7f0a38414c6fc4daf678acae834a819cecee", // alice-password
  },
  {
    userId: "1",
    username: "bob",
    passwordHash:
      "df53c27a66157885ba143e34f25d6380e12168b0f7da4f0c46efa54cd9a083b7", // bob-password
  },
  {
    userId: "2",
    username: "admin",
    passwordHash:
      "8e70fdbd0400b7a21539fd15fb4ab86c129f7cbd99261dbb0d95c18df8dec177", // admin-password
  },
];
...
export const loginUser = (username: string, password: string) => {
  const credential = credentials.find(
    (currentCredential) =>
      currentCredential.username.toLowerCase() === username.toLowerCase(),
  );
...
export const userHasCamera = (userId: string, cameraId: string) =>
  userCameras.some(
    (userCamera) =>
      userCamera.userId === userId && userCamera.cameraId === cameraId,
  );
...
export const createCameraForUser = (
  userId: string,
  args: Omit<Camera, "id">,
) => {
